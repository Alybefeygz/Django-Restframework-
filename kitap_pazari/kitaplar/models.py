...
class Kitap(models.Model):
    ...
    yaratilma_tarihi = models.DateTimeField(auto_now_add=True) # kere olacağı için
    güncellenme_tarihi = models.DateTimeField(auto_now=True) # her girişte olacağı için
...
class Yorum(models.Model):
    ...
    ) # Değerlendirmeyi 1 ile 5 arasında yapmak için kullandık bunu kullanmak için import ettin
